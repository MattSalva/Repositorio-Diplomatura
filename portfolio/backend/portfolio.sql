...
INSERT INTO `educacion` VALUES (1,'Universidad Técnologica Nacional - FRBA','Estudiante de la carrera Ingeniería en Sistemas','2020-04-01',NULL),(2,'ISFDyT N°42 Leopoldo Marechal','Profesor de Inglés graduado en todos los niveles de educación primaria y secundaria.','2015-04-01','2019-12-31'),(3,'EEST N°42 José C. Paz','Graduado con el título Técnico en Eléctronica','2010-04-01','2014-12-31');
...
INSERT INTO `proyectos` VALUES (1,'Tic-Tac-Toe','Un tic-tac-toe sin interfaz gráfica realizado puramente con Python 3 a modo de práctica'),(2,'Portfolio','Un portfolio personal con un backend armado en Java con Spring Boot y un frontend armado en Angular, ambos montados en infraestructura red, con una base de datos MySQL'),(3,'Hangman','Un \"hangman\" (\"ahorcado\") simple. Armado completamente en Python 3 a modo de práctica personal.'),(4,'Py-Memorygame','Un memory game realizado con Python 3 a modo de práctica para poder simular partidas del conocido juego de memoria, utilizando una base de datos de flashcards y un script simple para iterar sobre las mismas'),(5,'Py-Banking','Aplicación diseñada con Python 3 que simula el funcionamiento de una entidad bancaria para la creación y utilización de tarjetas de crédito. Utilizando los números de las mismas para identificar su validez.'),(6,'Py-Browser','Una aplicación hecha con Python 3 que simula la funcionalidad de un navegador web. Aplicación sin interfaz que guarda las páginas, permite ingresar URLs y navegar hacia delante y atrás en las páginas.');
...
INSERT INTO `usuarios` VALUES (1,'mathiassalva','81dc9bdb52d04dc20036dbd8313ed055');
...
-- Dump completed on 2023-05-04 22:19:47
